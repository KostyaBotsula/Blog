            ...
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div className="profile">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <img className="img-thumbnail profile-avatar" src="app/assets/img/default-avatars/avatar-01.png" alt="" />
                    </div>
                        ...
                        <div className="col-md-9 personal-info">
                            <form className="form-horizontal" role="form">
                                <div className="row">
                                    ...
                                    <div className="form-group">
                                        <label className="col-md-9 control-label"></label>
                                        <div className="col-md-3">
                                            <input type="submit" className="btn btn-primary settings-btn custom-button"
                                                   value="Сохранить" />
                                        </div>
                                    </div>
                                </div>
