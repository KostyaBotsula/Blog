  ...
  render: function() {
    ...
    <div className="login-wrap">
        <div className="login-html">
            ...
            <input id="tab-1" type="radio" name="tab" className="login" /><label htmlFor="tab-1" className="tab">Вход</label>
                ...
                <div className="sign-up-htm">
                    <div className="group">
                        ...
                        <input id="password-repeat-sign-up-form" className="text-login" type="password"
                               data-type="password" data-toggle="popover" data-trigger="manual" data-content="Неверное подтверждение пароля" />
